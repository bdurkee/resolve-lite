 ...
 *    {@link ResolveParser.FacilityDeclContext}s or enhancements whose
 *    specfied implementations are preceded by the <tt>externally</tt>
 *    keyword.</li>
 *
 ...
 *
 *    <li><strong>Explicit</strong> imports are any mentioned explicitly in
 *    the <tt>imports</tt> list in a module's preamble.</li>
 * </ul>
 */
