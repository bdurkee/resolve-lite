...
public class Standard_Integer_Realiz extends RESOLVEBase implements Integer_Template {
    ...
    @Override
    public RType Product(RType i1, RType i2) {
        return new Integer(((Integer)i1).val * ((Integer)i2).val);
    }

    @Override
    public RType Mod(RType i1, RType i2) {
        return new Integer(((Integer)i1).val % ((Integer)i2).val);
    }

    @Override
    public RType Negate(RType i1) {
