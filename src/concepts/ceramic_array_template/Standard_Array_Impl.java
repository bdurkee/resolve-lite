...
import concepts.integer_template.Standard_Integer_Impl;
import edu.clemson.resolve.runtime.*;

public class Standard_Array_Impl extends RESOLVEBase
        implements
    ...
    public Standard_Array_Impl(RType type, RType Lower_Bound, RType Upper_Bound) {
        this.type = type;
        this.lowerBound = ((Standard_Integer_Impl.Integer)Lower_Bound).val;
        this.upperBound = ((Standard_Integer_Impl.Integer)Upper_Bound).val;
    }

    @Override public void Swap_Entry(RType A, RType e, RType i) {
        int adj = ((Standard_Integer_Impl.Integer)i).val - lowerBound;
