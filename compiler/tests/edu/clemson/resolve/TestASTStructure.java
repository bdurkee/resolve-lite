...
public class TestASTStructure extends BaseTest {
    ...
    private static String getClassStr(PExp exp) {
        ...
        return (((PApply) exp).getDisplayStyle()).getStyleName()+className;
    }

    @Test public void testPSymbolStructure() {
        TypeGraph g = new TypeGraph();
        String[] expected = {
            "<InfixPApply:begin>:x + 1 * y\n" +
            "<PSymbol:begin>:+\n" +
            "<PSymbol:end>:+\n" +
            "<PSymbol:begin>:x\n" +
            "<PSymbol:end>:x\n" +
            "<InfixPApply:begin>:1 * y\n" +
            "<PSymbol:begin>:*\n" +
            "<PSymbol:end>:*\n" +
            "<PSymbol:begin>:1\n" +
            "<PSymbol:end>:1\n" +
    ...
    @Test public void testPAltStructure() {
        ...
        String[] expected = {
            ...
            "<PSymbol:begin>:@e\n" +
            "<PSymbol:end>:@e\n" +
            "<InfixPApply:begin>:q = @P.Trmnl_Loc\n" +
            "<PSymbol:begin>:=\n" +
            "<PSymbol:end>:=\n" +
            "<PSymbol:begin>:q\n" +
            "<PSymbol:end>:q\n" +
            ...
            "<InfixPApply:end>:q = @P.Trmnl_Loc\n" +
            "<PrefixPApply:begin>:@P.Lab(q)\n" +
            "<PSymbol:begin>:@P.Lab\n" +
            "<PSymbol:end>:@P.Lab\n" +
            "<PSymbol:begin>:q\n" +
            "<PSymbol:end>:q\n" +
            "<PrefixPApply:end>:@P.Lab(q)\n" +
