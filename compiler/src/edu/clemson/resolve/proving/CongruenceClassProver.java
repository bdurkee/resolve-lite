...
public final class CongruenceClassProver {
    ...
    public CongruenceClassProver(@NotNull RESOLVECompiler compiler,
        ...
        for (VC vc : preprocessedVcs) {
            ...
            //DIFFERENCES in m_symbol indices have to do with the order of conjuncts in the
            //antecedents/consequents.  See addPExp in VerificationConditionCongruenceClosureImpl,
            //they are added based on the order of conjuncts generated by the vc generator.
