...
public interface ScopeSearchPath {
     ...
     * {@link MathSymbolTable} containing any imports, returning a list of matching {@link Symbol}s.
     * <p>
     * If there are no matches, returns an empty list. If more than one match is found and {@code searcher} expects no
     * more than one match, throws a {@link DuplicateSymbolException}.</p>
     *
     * @param searcher a {@link TableSearcher} to apply to each scope along the search path
