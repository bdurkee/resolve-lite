...
/**
 * A {@link MSymbolExp} represents a reference to a named element such as a
...
public class MSymbolExp extends MExp {
    ...
    private final List<MExp> arguments = new ArrayList<MExp>();
    ...
    public static class MSymbolExpBuilder implements Builder<MSymbolExp> {
        ...
        public MSymbolExpBuilder mathType(MTType e) {
            this.mathType = e;
            return this;
        }

        public MSymbolExpBuilder mathTypeValue(MTType e) {
