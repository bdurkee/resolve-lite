...
public class SymmetricVisitor {
    ...
    public final boolean visit(MTType t1, MTType t2) {
        ...
        try {
            ...
            if ( myMultiplexer.getReturn() ) {
                List<? extends MTType> t1Components = t1.getComponentTypes();
                List<? extends MTType> t2Components = t2.getComponentTypes();
                if ( t1Components.size() != t2Components.size() ) {
                    ...
                    Iterator<? extends MTType> t1ComponentIter =
                            t1Components.iterator();
                    Iterator<? extends MTType> t2ComponentIter =
                            t2Components.iterator();
    ...
    private class Multiplexer extends TypeVisitor {
        ...
        public void beginMTPowertypeApplication(MTPowersetApplication t) {
            myReturn =
    ...
    public boolean beginMTPowertypeApplication(MTPowersetApplication t1,
